document.addEventListener('DOMContentLoaded', function () {
    ...
    // 初始状态，鼠标悬停提示为 "点击展开目录"
    directoryToggle.setAttribute('title', 'Expand TOC');
    ...
    directoryToggle.addEventListener('click', function () {
        ...
        if (isExpanded) {
            ...
            directoryToggle.setAttribute('title', 'Collapse TOC');  // 更新提示为 "收起目录"
        } else {
            ...
            directoryToggle.setAttribute('title', 'Expand TOC');  // 更新提示为 "展开目录"
        }
    });
    ...
    // 添加“目录”字样
    tocHtml += '<p class="toc-label">Table of contents</p><ul>';
